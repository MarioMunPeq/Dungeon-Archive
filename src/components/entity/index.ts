...
export { createSearchResultItems } from "./entity-display";
export type { SearchResultItem } from "./entity-display";

export { entityRefFromCanonicalId, badgeVariantForCategory } from "./entity-reference";
